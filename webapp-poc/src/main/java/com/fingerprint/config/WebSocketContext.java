...
import com.fingerprint.util.wsclient.object.SimpleSessionHandler;
import com.fingerprint.util.wsclient.service.WebSocketService;
import com.fingerprint.util.wsclient.service.impl.WebSocketServiceImpl;
...
//		return new WebSocketServiceImpl(stompSessionHandler());
//	}
//
//	@Bean
