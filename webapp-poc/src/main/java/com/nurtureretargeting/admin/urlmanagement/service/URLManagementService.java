package com.nurtureretargeting.admin.urlmanagement.service;
...
public class URLManagementService {
	...
	public URLManagementService(URLImportService URLImportService, URLTaggedService URLTaggedService,
			URLSiteMapService URLSiteMapService) {
