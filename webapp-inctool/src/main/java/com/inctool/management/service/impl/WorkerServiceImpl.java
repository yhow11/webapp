...
public class WorkerServiceImpl implements WorkerService {
	...
	public WorkerForm save(WorkerForm workerForm) throws Exception {
		...
		return workerMapper.unmarshal(iNCWorkerService.save(workerMapper.marshal(workerForm)));
	}
	@Override
	public WorkerForm get(String id)   throws Exception{
		// TODO Auto-generated method stub
		return workerMapper.unmarshal(iNCWorkerService.get(id));
	}
	@Override
	...
	public FormResponse<WorkerForm> getAll(FormParam<WorkerForm> param) throws Exception {
		...
		INCWorkerModel model = workerMapper.marshal(param.getData());
		...
		response.setData(workerMapper.unmarshal(iNCWorkerService.getAll(queryParam)));
		return response;
	}
