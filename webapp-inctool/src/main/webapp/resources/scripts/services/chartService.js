...
angular.module('incToolApp')
   ...
   return {
	   getMonthyCandidatesOfCompletion: function(id) {
           return $http.post('api/chart/getMonthyCandidatesOfCompletion?id=' + id).then(handleRemoveSuccess, handleError('Error getting all members'));
       },
