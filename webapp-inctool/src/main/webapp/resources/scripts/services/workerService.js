...
//    		
   ...
   return {
	   getAll: function(id, page, limit) {
           return $http.post('api/worker/getAll', {page: page, limit: limit, data: {id: id}}).then(handleSuccess, handleError('Error getting all members'));
       },
       get: function(id) {
