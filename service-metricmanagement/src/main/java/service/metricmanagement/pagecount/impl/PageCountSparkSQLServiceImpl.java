...
public class PageCountSparkSQLServiceImpl extends SparkSQLTemplate implements PageCountService{
	...
	public PageCountSparkSQLServiceImpl(SQLContext sqlContext, String zookepers) throws Exception {
		super(sqlContext, zookepers, SparkSQLUtil.getTableName(PageCountModel.class));
